...
export class EnderecosComponent implements OnInit {
  ...
  infor = [
...

    {
      ...
      titulo:"Tabacaria Bragança",
      end:"R. Cel. José Caetano Ribeiro, 2-80 - Centro, Bragança - PA, 68600-000",
